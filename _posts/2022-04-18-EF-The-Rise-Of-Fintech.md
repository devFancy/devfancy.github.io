...
#### Wealth Management이 성장하게 된 배경 ⇒ 그에 대한 답변
...
* A1) 기존 금융 기관의 procurement 와 partnership teams과 함께 일하는 것이 어렵다 → 새로운 시스템을 도입하기 쉽지 않음
  
* A2) 많은 regtech startup이 인수되어버린다.
  
* A3) 큰 IT 기업들이 그들 자신의 해결책을 제공한다.
