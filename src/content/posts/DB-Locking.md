...
![](/assets/img/cs/db/db-locking-1.png)

* [그림 1]은 트랜잭션 T1을 수행한 이후에 트랜잭션 T2를 수행한 예시다. (T1 -> T2)

![](/assets/img/cs/db/db-locking-2.png)
...
![](/assets/img/cs/db/db-locking-3.png)

* [그림 3]은 트랜잭션 T1,T2를 직렬 스케줄로 수행한 [그림 1]과 결과가 같으므로 모순이 없는 정확한 값이다.

![](/assets/img/cs/db/db-locking-4.png)
...
<img src="/assets/img/cs/db/db-locking-deadlock.png" width="500px">
...
![](/assets/img/cs/db/db-locking-pessimistic-lock.png)
...
![](/assets/img/cs/db/db-locking-optimistic-lock.png)
