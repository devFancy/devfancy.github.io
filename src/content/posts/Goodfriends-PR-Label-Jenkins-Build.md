...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-1.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-2.png)

## Repository 구성

![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-3.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-4.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-5.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-6.png)

해당 부분을 클릭하면 아래와 같은 설명을 확인하실 수 있습니다.

![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-7.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-8.png)

프로젝트 레포지토리 -> Setting -> Webhook 탭에 들어와서 웹훅을 새로 만듭니다. (Add Webhook 버튼 클릭)

![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-9.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-10.png)

Add webhook을 한 뒤 다시 등록한 웹 훅을 클릭하여 Recent Deliveries 탭을 확인하면,

> Webhooks / Manage webhook (detail)

![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-11.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-12.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-13.png)

`$.pull_request.merged`를 등록하여 Merge 되었는지 여부를 가져옵니다.

> BRANCH

![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-14.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-15.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-16.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-17.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-18.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-19.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-20.png)
...
![](/assets/img/project/goodfriends/goodfriends-pr-label-jenkins-build-21.png)
