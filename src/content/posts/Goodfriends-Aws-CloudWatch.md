...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_1.png)
...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_2.png)
...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_3.png)

5. 이름 지정, 검토 및 생성
- 역할 이름 - ec2-monitoring (원하는 이름으로 해도 상관없다.)
- 역할 이름 지정 후 역할 생성

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_4.png)

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_5.png)
...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_6.png)

- IAM 역할에 방금 만들어둔 role 선택후 저장

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_7.png)
...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_8.png)
...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_9.png)
...
![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_10.png)

- 지표 선택

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_11.png)

- CWAgent - InstanceId, device, fstype, path3 - CloudWatch를 붙여둔 instance

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_12.png)

- 지표 및 조건 지정 
  - 기간 - 1시간으로 변경 
  - 1시간마다 디스크의 사용량을 확인

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_13.png)

- 조건: 디스크의 사용량이 50% 이상일 때 알림을 준다.

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_14.png)

- 작업 구성 
  - 주제가 이미 존재한다면 기존 주제 사용 
  - 주제가 없다면 아래 예시처럼 주제 구성 후 주제 생성

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_15.png)

- 주제 생성 후 기존 SNS 주제 선택 및 “다음” 선택

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_16.png)

- 이름 및 설명 추가

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_17.png)

- 경보 생성
- 위의 주제에서 등록한 이메일에서 confirm (최초만 적용)

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_18.png)

이제 Test 인스턴스의 용량이 50% 이상을 사용한다면 이메일로 알림이 온다.

![](/assets/img/project/goodfriends/Goodfriends_Aws_CloudWatch_result.png)
