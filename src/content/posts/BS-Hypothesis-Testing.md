...
* 가설 검정의 종류
  ...
  * 한쪽꼬리(단측)검정 : 대립가설의 기호의 방향을 따름.
  ...
  ![](/assets/img/business-statistics/bs-hypothesis-testing_1.png){: width="600"}
...
![](/assets/img/business-statistics/bs-hypothesis-testing_2.png){: width="600"}
...
* 5단계: 귀무가설의 기각여부 결정
  ...
  * 임계값 또는 기각영역과 비교
  ...
  ![](/assets/img/business-statistics/bs-hypothesis-testing_3.png){: width="500"}

  ![](/assets/img/business-statistics/bs-hypothesis-testing_4.png){: width="500"}
...
![](/assets/img/business-statistics/bs-hypothesis-testing_5.png){: width="600"}
