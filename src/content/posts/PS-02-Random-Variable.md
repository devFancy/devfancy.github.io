...
![](/assets/img/university/probability-statistics/ps-02-random-variables_1.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_2.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_3.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_4.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_5.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_6.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_7.png)


* for example, taking c = 3 gives $P(\mu - 3\sigma ≤ X ≤ \mu + 3\sigma ) ≥ 1 - \frac{1}{3^{2}} = 0.89$

![](/assets/img/university/probability-statistics/ps-02-random-variables_8.png)
...
![](/assets/img/university/probability-statistics/ps-02-random-variables_9.png)
...
* Quartiles and Interquartile Range
  ...
  * Interquartile range: The distance between the two quartiles
  ...
  ![](/assets/img/university/probability-statistics/ps-02-random-variables_10.png)
