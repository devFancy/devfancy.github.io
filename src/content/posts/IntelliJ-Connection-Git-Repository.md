...
![](/assets/img/tool/intellij/IntelliJ-Connection-Git-Repository_1.png)

* 우선 인텔리제이에서 깃허브 저장소에 올리고 싶은 프로젝트를 open한다.

![](/assets/img/tool/intellij/IntelliJ-Connection-Git-Repository_2.png)

* 그런 다음에 IntelliJ IDEA -> Settings(Preferences)를 클릭하여 검색창에 git을 입력한다.

* git이 설치되었으면 git 밑에 있는 github 탭을 클릭하여 깃허브에 로그인을 하여 연동시킨다.

![](/assets/img/tool/intellij/IntelliJ-Connection-Git-Repository_3.png)
...
![](/assets/img/tool/intellij/IntelliJ-Connection-Git-Repository_4.png)
