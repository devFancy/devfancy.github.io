...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_1.png){: width="400"}
...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_2.png){: width="400"}
...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_3.png){: width="400"}
...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_4.png){: width="400"}
...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_5.png){: width="400"}
...
* $R$: Time between retransmission packets (재전송하는데 걸리는 시간)
  ...
  * Normalized with respect to the packet transmission time T
  ...
  ![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_6.png){: width="400"}
...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_7.png){: width="400"}
...
![](/assets/img/probability-statistics/ps-04-continuous-probability-distributions_8.png){: width="400"}
